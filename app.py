...
badges = [
    ...
    ("https://img.shields.io/badge/heroku-%23430098.svg?style=for-the-badge&logo=heroku&logoColor=white", "heroku.com"),
    ...
    ("https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54","python.org")
    ]
app = Flask(__name__)
def get_lat_lon(ip):
    if ip == "127.0.0.1":
